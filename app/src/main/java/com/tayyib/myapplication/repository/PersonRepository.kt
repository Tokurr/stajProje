...
class PersonRepository @Inject constructor(private val api: Api){


    suspend fun getPerson(token: String, userId: String): Flow<Resource<PersonResponse>> {
        ...
        return flow {
            ...
            val response   =  try {
                  api.getBimserPerson(token, userId)
            }
