...
class TicketStatusRepository @Inject constructor(private val api: Api){

    suspend fun getTicketStatus(token: String): Flow<Resource<TicketStatusResponse>> {
        ...
        return flow {
            ...
            val response = try{
                ...
                api.getTicketStatus(token = token)
